...
?>
<script type="text/javascript" src="plugin/tiny/tiny_mce.js"></script>
<script type="text/javascript">
    ...
    theme_advanced_buttons6: "tablecontrols,|,pastetext,pasteword,|,fullpage,openmanager",
    ...
    <?php if (isset($_GET['fullpage'])){ echo 'relative_urls : false,remove_script_host : false,convert_urls : true,'; }?>
