...
$this->Tools()->addCss("css/bootstrap.css");
$this->Tools()->addCss("css/small-business.css");
$this->Tools()->addJs("js/jquery-1.10.2.js");
$this->Tools()->addJs("js/bootstrap.js");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">
                        <img src="http://placehold.it/150x50&text=MyFrame&nbsp;Sample" alt="">
                    </a>
                </div>
        ...
        <div class="container">
            ...
            <footer>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <p>Copyright &copy; Company 2013 <br/>
                            <?php
                            //-------------------------
